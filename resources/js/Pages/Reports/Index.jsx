                    ...
                    <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-6">
                        ...
                        <form onSubmit={submit} className="print:hidden grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[170px_170px_auto_auto_auto] gap-3 items-end">
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="inline-flex items-center justify-center gap-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 disabled:bg-slate-400 text-white px-5 py-3 font-bold shadow-lg shadow-indigo-600/25 transition-all"
                            >
                            ...
                            <button
                                type="button"
                                onClick={resetFilter}
                                className="inline-flex items-center justify-center gap-2 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-200 px-5 py-3 font-bold transition-all"
                            >
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-3 font-bold shadow-lg shadow-emerald-600/25 transition-all"
                            >
